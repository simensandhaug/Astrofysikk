...
const loadPage = () => {
    ...
    contentContainer.innerHTML = `<div id="headerContainer" onclick="location.href='index.html'"><h1>Astrofysikk</h1><p>Stjerneinfo</p><p>Trykk for å gå tilbake</p></div><br>`;
    contentContainer.innerHTML += `<div id="starList"></div>`;
    stars.forEach(star => {
